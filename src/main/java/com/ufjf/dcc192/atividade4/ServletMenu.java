...
public class ServletMenu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String numAtiv = contexto.getInitParameter("numAtiv");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>LDSW - Atividade " + numAtiv + "</h1>");
            out.println("<h2>" + saudacao + ", " + resposta + " você está logado.</h2>");
    ...
    @Override
    public void init() {
        saudacao = getInitParameter("saudacao");
    }
